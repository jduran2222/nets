   ...
   <div class="container">
    <div class="row">
        <div id="header" class="col-lg-12">
            <h1>Notas de Asignaturas Ordinarias</h1>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <b>Evaluación:</b> <?php echo $fila['prueba'] ?> 
        </div>
        <div class="col-lg-4">
...
<?php
	...
	asignaturas.Asignatura as Asignatura,pruebas.idPrueba, nota from alumnos, 
        asignaturas, notas2, pruebas where (alumnos.idAlumno = notas2.idAlumno) and 
        (asignaturas.idAsignatura = notas2.idAsignatura)and 
        (alumnos.idAlumno = $clave)and(notas2.idPrueba = pruebas.idPrueba) and "
                . "(pruebas.activada = 1)";
