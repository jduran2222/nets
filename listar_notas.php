	...
	$datos = mysqli_query ($con, $selectSQL);
        ...
        $selectSQL1 = "SELECT asignaturas.idAsignatura, 
                ...
                CASE 
                    ...
                    ELSE 'Suspenso'
                END AS calificacion
                from asignaturas, notas2, pruebas where (asignaturas.idAsignatura = notas2.idAsignatura)and 
                (notas2.idAlumno = '$idAlumno')and (pruebas.idPrueba = notas2.idPrueba) and (pruebas.activada = 1)";	
