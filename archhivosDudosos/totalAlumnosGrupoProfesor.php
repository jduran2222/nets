    ...
    <table id="tabladatos" class="table">  
        ...
        <?php while ($row = $result->fetch_assoc()) { ?>
            <tr>
                ...
                <td>
                    <a class = "btn btn-default" href="regNotasAlumnoGrupoProfesor.php?clave=<?php echo $row['idAlumno']; ?>&curso=<?php echo $row['curso']; ?>&nombre=<?php echo $row['nombre']; ?>&apellidos=<?php echo $row['apellidos']; ?>&grupo=<?php echo $row['grupo']; ?>">Ordinarias
