...
<link rel="stylesheet" href="css/custom.css">   
 ...
 <div class="container"> 
  ...
  <h2>Gestión de<b> Notas por Asignatura/Grupo</b></h2>
   <div class="content">
       ...
       <div class="panel-body">
         ...
         <div class ="container">
                <form name = "f1" id ="f1" method = "POST" action ="datosAlumnoGrupo.php">
                    <div class="row">
                        <div class="col-sm-2"> 
                            <select class="btn btn-primary" style = "text-align:left" name ="grupos" onchange="alumnosGrupoNotas.php">
                                <option value="o" selected ="selected"> Seleccione Grupo</option>
                                <?php
                                    $selectedSQL="SELECT * FROM grupos where (idCurso = '$curso')";
