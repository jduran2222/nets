...
$consulta = "select * from cursos where nivel like '%$q%'";
...
{	
	...
	$this->Cell(55);
	// T�tulo
	$this->Cell(55,10,utf8_decode('LISTA DE CURSOS'),0,0,'L');
        $this->Ln(35);
        $this->Cell(45,6, utf8_decode('Criterio de Selección:'),0,0,'L');
        $this->SetFont('Arial','I',10);
        $this->Cell(45,6,strtoupper($nivel),0,0,'L');
        $this->Ln();
        $this->SetFont('Arial','B',12);
        ...
        $this->Cell(45,6,'id Curso',1,0,'L',1);
        $this->Cell(45,6,'Curso',1,0,'L',1);       
        $this->Cell(45,6,'Nivel',1,0,'L',1);
...
while($fila = mysqli_fetch_array($query))
{
    ...
    $pdf->Cell(45, 6, utf8_decode($idCurso),1,0,'L',0);
    $pdf->Cell(45, 6, utf8_decode($curso), 1, 0, 'L', 0);
    $pdf->Cell(45, 6, utf8_decode($nivel), 1, 0, 'L', 0); 
    $num++;
$pdf->Ln();
}
